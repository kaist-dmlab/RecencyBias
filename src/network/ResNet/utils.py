...
weight_regularizer = tf.keras.regularizers.l2(0.04)
...
def resblock(x_init, channels, is_training=True, use_bias=True, downsample=False, keep_prob=1.0, scope='resblock') :
    with tf.variable_scope(scope) :
...
def bottle_resblock(x_init, channels, is_training=True, use_bias=True, downsample=False, keep_prob = 1.0, scope='bottle_resblock') :
    with tf.variable_scope(scope) :
